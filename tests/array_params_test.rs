...
fn test_array_parameter_serialization() {
    ...
    let tags: Option<Vec<String>> = Some(vec!["tag1".to_string(), "tag2".to_string(), "tag3".to_string()]);
...
fn test_reqwest_query_with_comma_separated_values() {
    ...
    assert_eq!(url_with_params.as_str(), "https://api.example.com/pets?tags=tag1%2Ctag2%2Ctag3");
